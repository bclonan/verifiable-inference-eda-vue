import type { ContextEnvelope, DTO } from "../../core/types.js";
import { canonicalJSONStringify } from "../../core/canonicalize.js";
import { sha256Hex } from "../../core/hash.js";

export async function runMockSemanticExtract(ctx: ContextEnvelope): Promise<{
    output: DTO;
    evidence: Record<string, string>; // name -> blob string
    runtimeId: string;
}> {
    ...
    const events = (eventsDto?.data?.events || []) as any[];
