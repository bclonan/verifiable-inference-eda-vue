...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "C:/Users/bradl/OneDrive/Documents/GitHub/verifiable-inference-eda-vue/node_modules/.pnpm/ufo@1.6.3/node_modules/ufo/dist/index.mjs";
import { u as useHead } from "./v3-B7ac-1pK.js";
...
import "node:stream";
import "C:/Users/bradl/OneDrive/Documents/GitHub/verifiable-inference-eda-vue/node_modules/.pnpm/@unhead+vue@2.1.2_vue@3.5.27_typescript@5.9.3_/node_modules/@unhead/vue/dist/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-ea851a8a><div class="fixed left-0 right-0 spotlight z-10" data-v-ea851a8a></div><div class="max-w-520px text-center z-20" data-v-ea851a8a><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-ea851a8a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-ea851a8a>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-ea851a8a>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.20.2_@parcel+watcher@2.5.4_@vue+compiler-sfc@3.5.27_cac@6.7.14_db0@0.3.4_ioredis@5.9.2_uxdppj2vdeplbsdl3xurwlb5da/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ea851a8a"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-77B028oO.js.map
